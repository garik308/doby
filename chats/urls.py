...
from chats.views import ChatRoomDetailView, MessageMediaRetrieveView, MessageCreateView, ChatRoomCreateView

urlpatterns = [
    path('', ChatRoomCreateView.as_view(), name='chat-room-create'),
